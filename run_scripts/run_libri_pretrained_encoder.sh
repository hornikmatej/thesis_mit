...
CUDA_VISIBLE_DEVICES="0" python run_speech_recognition_seq2seq.py \
	...
	--model_name_or_path="./seq2seq_wav2vec2_bart-base_pretrained_encoder" \
	--dataset_config_name="clean" \
	--train_split_name="train.100" \
	--eval_split_name="validation" \
	--output_dir="./seq2seq_wav2vec2_bart-base_pretrained_encoder/training_librespeech" \
	...
	--wandb_project="seq2seq_encoder-decoder_pretrained_encoder" \
