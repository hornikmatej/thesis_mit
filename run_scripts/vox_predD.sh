...
CUDA_VISIBLE_DEVICES="0" python run_speech_recognition_seq2seq.py \
	...
	--model_name_or_path="./seq2seq_wav2vec2_bart-base_denois-enc" \
	--dataset_config_name="en" \
	--train_split_name="train" \
	--eval_split_name="validation" \
	--test_split_name="test" \
	--output_dir="./seq2seq_wav2vec2_bart-base_denois-enc/training_voxpopuli" \
...
CUDA_VISIBLE_DEVICES="0" python run_speech_recognition_seq2seq.py \
	--dataset_name="facebook/voxpopuli" \
	--model_name_or_path="./seq2seq_wav2vec2_bart-base_infill-enc" \
	--dataset_config_name="en" \
	--train_split_name="train" \
	--eval_split_name="validation" \
	--test_split_name="test" \
	--output_dir="./seq2seq_wav2vec2_bart-base_infill-enc/training_voxpopuli" \
	--preprocessing_num_workers="1" \
	--dataloader_num_workers="16" \
	--dataloader_prefetch_factor="2" \
	--length_column_name="input_length" \
